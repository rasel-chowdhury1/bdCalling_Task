        ...
        <div className="w-full flex flex-col md:flex-row gap-4 ">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 w-full md:w-4/6">
            ...
            <div className="flex justify-between mt-6">
              <button className="bg-gray-200 px-2 md:px-4 py-2 rounded-lg hover:bg-gray-300">Return to shop</button>
              <button className="bg-gray-800 text-white px-2 md:px-4 py-2 rounded-lg hover:bg-gray-900">Update Cart</button>
            </div>
          </div>
